...
for user_id, profile in profiles.items():
    # Adapter le format pour correspondre à ce que attend le Lambda
    # V2 profile: {num_articles, total_time, avg_time, total_clicks, articles, weights}
    # Lambda attend: {articles_read, ...}
...
# Le Lambda peut fonctionner sans embeddings si on ne fait que du collaborative filtering
fake_embeddings = {}
